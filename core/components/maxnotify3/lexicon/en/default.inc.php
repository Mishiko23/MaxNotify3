...
$_lang['setting_maxnotify3.max_api_url_desc'] = 'Official MAX messages endpoint: https://platform-api2.max.ru/messages. For MAX Business API, the Russian Ministry of Digital Development certificate must be trusted on the server.';
